...
function Header({ idioma, setCurrentPage, setUsername, username }) {
    ...
    if (!idioma) {
        ...
        return (
            <div style={{ backgroundColor: '#484444' }} className="relative w-full h-[75px] flex items-center justify-center">
                <button className=" absolute inline-block text-left left-5 ml-10 hover:brightness-110" onClick={handleHomePage}>
                    <img src="/atras2.png" alt="Volver" className="h-[48px] w-[48px]" />
                </button>
                {/* Logo */}
                <img src="/pinturillo2_tipo2.png" alt="Logo" className="w-[250px] h-[75px] flex justify-center" />
            </div>
